# 240206 pure_astar(DWA) warehouse 버전
...
class AStarPlanner:
    ...
    def calc_flow_map(self, r_linear, r_angular, skew_x, skew_y, pedsim_list=None):
        ...
        vertices = np.array([[0,0],[0,200],[200,200],[200,0]])
        polygon_array = create_polygon([200,200], vertices)
        
        self.flow_map = np.array(self.flow_map)
                
        self.flow_map = polygon_array   # (200,200)
