...
class Config:
    ...
    def __init__(self):
        ...
        self.max_yaw_rate = math.pi# 40.0 * math.pi / 180.0  # math.pi# # [rad/s]    # math.pi = 3.14 = pi = 180
        self.max_accel = 0.2  # [m/ss]
        self.max_delta_yaw_rate = math.pi #40.0 * math.pi / 180.0  # [rad/ss]   # 221219 math.pi로 하면 더 정밀하게 되는거 같은데 더 느려짐?
        self.v_resolution = 0.01  # [m/s]
        self.yaw_rate_resolution = 0.1 * math.pi / 180.0  # [rad/s]
        self.dt = 0.1  # [s] Time tick for motion prediction
        self.predict_time = 1.0  # [s]   # 3.0 -> 1.0 # 221219
        ...
        self.robot_width = 0.25  # [m] for collision check
        self.robot_length = 0.25  # [m] for collision check
        # obstacles [x(m) y(m), ....]
        self.ob = np.array([[-3.5, 2.5],
                            [-3.0, 2.5],
                            [-2.5, 2.5],
                            [-2.0, 2.5],
                            [-1.5, 2.5],
